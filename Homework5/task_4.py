...
def scrabble(word):
    ...
    result = [k                         # вернуть кортеж ключей
              for i in word             # для каждой буквы в слове
              for v, k in dct.items()   # для значения и ключа в словаре
              if i in v]                # если буква из слова есть в значении в словаре
    points = sum(result)                # просуммируем кортеж
    return points
